...
class Config : public QObject {
  ...
  public:
    ...
    // JSON和YAML导出功能
    QString exportToJson(const QStringList &excludeKeys = QStringList()) const;
    QString exportToYaml(const QStringList &excludeKeys = QStringList()) const;
    ...
    QString getConfigLocationPath(ConfigLocation location) const;
